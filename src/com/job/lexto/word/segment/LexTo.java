...
import com.job.lexto.word.segment.ParseTree;
import com.job.lexto.word.segment.VTrie;
		...
		for (i = 0; i < typeList.size() - 1; i++) {
			...
			if ((curType == 3) || (curType == 4)) {
				...
				if ((nextType == 3) || ((nextType == 4)
						&& ((text.charAt(nextIndex - 1) == ' ') || (text.charAt(nextIndex - 1) == '\"') || (text.charAt(nextIndex - 1) == '(') || (text.charAt(nextIndex - 1) == '\''))))
