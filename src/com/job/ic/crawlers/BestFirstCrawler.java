...
public class BestFirstCrawler {
	private static Logger logger = Logger.getLogger(BestFirstCrawler.class);
...
//	public static UrlDAO ud;
	...
	public static synchronized void addPage(final double score, final String url) {
		...
		if (BestFirstCrawler.rel + BestFirstCrawler.non > BestFirstCrawler.limitPage) {
			System.out.println(BestFirstCrawler.rel);
			System.out.println(BestFirstCrawler.non);
			System.out.println(BestFirstCrawler.limitPage);
...
//		double total = rel + non;
	...
	public static void main(final String[] args) throws Exception {
		...
		System.out.println(String.valueOf(BestFirstCrawler.rel) + "\t" + BestFirstCrawler.non);
...
//			BestFirstCrawler.logger.info(String.format("%s\t%.2f\t%s\tParent:\t%.2f", url, score, progress(), qObj.getScore()));
...
//						logger.error(">>>>>>>>" + score + "\t" + l.getLinkUrl());
		...
		BestFirstCrawler.logger.info("finished");
